 ...
 *                                  Local                                     *
 *============================================================================*/
typedef struct _Ender_Attr_Int
{
	Ender_Attr_Int_Set set;
	Ender_Attr_Int_Get get;
} Ender_Attr_Int;
/*----------------------------------------------------------------------------*
 *                        The exernal attr interface                           *
 *----------------------------------------------------------------------------*/
static void * _ender_attr_int_init(Egueb_Dom_Node *n)
{
	Ender_Attr_Int *thiz;

	thiz = calloc(1, sizeof(Ender_Attr_Int));
	return thiz;
}

static void _ender_attr_int_deinit(Egueb_Dom_Node *n, void *data)
{
	free(data);
}

static Eina_Bool _ender_attr_int_value_get(Egueb_Dom_Node *n, void *data,
		Egueb_Dom_Attr_Type type, Egueb_Dom_Value *value)
{
	Ender_Attr_Int *thiz = data;
...
static Eina_Bool _ender_attr_int_value_set(Egueb_Dom_Node *n, void *data,
		Egueb_Dom_Attr_Type type, Egueb_Dom_Value *value)
{
	Ender_Attr_Int *thiz = data;
	Egueb_Dom_Node *owner;
...
static const Egueb_Dom_Value_Descriptor * _ender_attr_int_value_descriptor_get(
...
static Egueb_Dom_Attr_External_Descriptor _descriptor = {
	/* init 		= */ _ender_attr_int_init,
	/* deinit 		= */ _ender_attr_int_deinit,
	/* value_descriptor_get	= */ _ender_attr_int_value_descriptor_get,
	/* value_get 		= */ _ender_attr_int_value_get,
	/* value_set	 	= */ _ender_attr_int_value_set,
};
/*============================================================================*
 *                                 Global                                     *
 *============================================================================*/
