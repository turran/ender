 ...
 *----------------------------------------------------------------------------*/
static Egueb_Dom_String * _ender_element_states_tag_name_get(
		Egueb_Dom_Node *node, void *data)
{
	return egueb_dom_string_ref(ENDER_ELEMENT_STATES);
}

static Eina_Bool _ender_element_states_child_appendable(Egueb_Dom_Node *n,
...
static Egueb_Dom_Element_External_Descriptor _descriptor = {
	/* init 		= */ NULL,
	/* deinit 		= */ NULL,
	/* tag_name_get		= */ _ender_element_states_tag_name_get,
	/* child_appendable 	= */ _ender_element_states_child_appendable,
	/* process 		= */ NULL,
};
/*============================================================================*
 *                                 Global                                     *
